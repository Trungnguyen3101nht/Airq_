...
public:
    ...
    void updateMORE(float sound, float vibration, int battery);
    void updateSEN55(
...
private:
    ...
    M5Canvas *_soundCanvas;
    int32_t _soundCanvasX;
    int32_t _soundCanvasY;

    M5Canvas *_vibrationCanvas;
    int32_t _vibrationCanvasX;
    int32_t _vibrationCanvasY;

    M5Canvas *_batteryCanvas;
    int32_t _batteryCanvasX;
    int32_t _batteryCanvasY;
